        ...
        **kwargs,
        ...
        for i, step in enumerate(iterator):
            ...
            if mask is not None:
                ...
                img = img_orig * mask + (1.0 - mask) * img  # keep original & modify use img
        ...
        **kwargs,
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.0:
            ...
            if isinstance(c, torch.Tensor) or isinstance(c, dict):
                e_t_cond, _, _ = self.model.model_predictions(x, t, c, dropout_actions=False, **kwargs)
                e_t_uncond, _, _ = self.model.model_predictions(
                    x, t, unconditional_conditioning, dropout_actions=False, **kwargs
                )
            else:
        ...
        pred_x0 = self.model.predict_start_from_noise(x, t, e_t)
